...
(shared contracts + utilities), F3 (data layer + Patient Identity), and
F4 (session issuance/verification + route protection) shipped. See
docs/29 §14 for implementation notes and the full F1–F5 Foundation batch
sequence.
