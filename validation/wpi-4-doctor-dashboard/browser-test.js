...
async function main() {
  ...
  try {
    ...
    // ---- 9. Pure-function unit checks against window.WiseDoctorDashboard, mirroring window.WiseDashboard's own precedent ----
    {
      ...
      check('Doctor Dashboard: the hand-ported DOCTOR_MODULE_REGISTRY carries exactly ten entries (patient_roster, appointments, inventory, pillfill_orders, analytics, ai_assistant, holoscan_review, medication_history, milestone_review, digital_twin_review, as of Batch PXP-12)', registryLength === 10);
